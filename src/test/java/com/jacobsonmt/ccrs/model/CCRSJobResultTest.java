...
public class CCRSJobResultTest {
    ...
    private static String HEADER = String.join( "\t", CCRSJobResult.HEADER );

    private static String baseCSVResult = "sp|P07766|CD3E_\t1\tM\t41\t0.785\t0.785\t0.785\t0.785\t0.785\t0.785\t0.785\t0.785\t0.785\t0.785\t0.785\t0.785\t0.785\t0\t0.785\t0.785\t0.785\t0.785\t0.785\t0.785\t0.785\n" +
    ...
    public void parseSlim() {
        CCRSJobResult result = CCRSJobResult.createWithOnlyTaxa( new Taxa( "test_OX", 5 ) );
    ...
    public void parseTaxaWhenExists() {
        ...
        CCRSJobResult result = CCRSJobResult.parseResultCSVStream( resultCSVInputStream );
...
//        InputStream resultCSVInputStream = new ByteArrayInputStream(resultCSV.getBytes( StandardCharsets.UTF_8 ));
//        CCRSJobResult result = CCRSJobResult.parseResultCSVStream( resultCSVInputStream );
//        assertThat( result.getResultCSV() ).isEqualTo( "malformed_OX\t-1\n" + HEADER + "\n" + baseCSVResult );
//    }
//
//    @Test
...
//        InputStream resultCSVInputStream = new ByteArrayInputStream(resultCSV.getBytes( StandardCharsets.UTF_8 ));
//        CCRSJobResult result = CCRSJobResult.parseResultCSVStream( resultCSVInputStream );
//        assertThat( result.getResultCSV() ).isEqualTo( "missing_OX\t-1\n" + HEADER + "\n" + baseCSVResult );
//    }
//
//    @Test
...
//
//    @Test
//    public void getResultCSVWhenNull() {
//        CCRSJobResult result = new CCRSJobResult();
//        assertThat( result.getResultCSV() ).isNull();
//    }
